        ...
        try:
            ...
            async def my_event_handler(event):
                if event.message.from_id.user_id == chat_id:
                    if '#AD' in event.message.message or '#PAIDAD' in event.message.message or '#ad' in event.message.message or '#paidad' in event.message.message or '#paidAD' in event.message.message or 'bots.business/ads' in event.message.message or '#PaidAd' in event.message.message or 'sponsored' in event.message.message:
                        print(event)
